...
cf. \href{https://en.wikipedia.org/wiki/Exponentiation_by_squaring}{wikipedia, "Exponentiation by squaring"}

Observe that for positive integers,
\begin{equation}
\begin{gathered}
x^n = \begin{cases} x(x^2)^{\frac{n-1}{2}} & \text{ if $n$ odd } \\
(x^2)^{n/2} & \text{ if $n$ even }
\end{cases}
\end{gathered}
\end{equation}
