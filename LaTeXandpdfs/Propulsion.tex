...
\begin{equation}\label{Eq:StateVariableDefinitionLinearDifferentialSystem}
	...
	\end{gathered}
\end{equation}
where $\beta_j$, $0\leq j \leq n-1$ determined by
\begin{equation}
	\begin{aligned}
		& \beta_0 = b_0 \\
	...
	\end{aligned}
\end{equation}
with this choice of state variables, existence and uniqueness of solution of state equation is guaranteed. (EY ???) With the present choice of state variables, we obtain (derivation in Problem A-2-6):
