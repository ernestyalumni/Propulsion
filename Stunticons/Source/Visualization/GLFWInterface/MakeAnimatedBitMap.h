#ifndef VISUALIZATION_GLFW_INTERFACE_MAKE_ANIMATED_BITMAP_H
#define VISUALIZATION_GLFW_INTERFACE_MAKE_ANIMATED_BITMAP_H
  ...
  public:
    ...
    bool run(F& render_object)
    {
      ...
      while (!glfwWindowShouldClose(glfw_window.created_window_handle_))
      {
        ...
        render_object.run(mapped_device_pointer.device_pointer_, ticks++);
...
#endif // VISUALIZATION_GLFW_INTERFACE_MAKE_ANIMATED_BITMAP_H
